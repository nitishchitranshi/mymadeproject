...
<body onLoad="MM_preloadImages('img/sample1.png','img/cart_focused.png','img/login_focused.png','img/gift_focused.png')">
	<header class="trasparent_nav">
		<div class="logo">
				<a href="#"><img src="img/mymade_Logo.png" alt="mymade"></a>
	  </div>
		<div>
			<nav>
				<ul>
					<li><a href="enquire.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('enquire','','img/sample1.png',1)"><img id="enquire" src="img/enquire.png" alt="Enquire"></a></li>
                  <li style="cursor:default"><img src="img/separator.png"></li>
					<li><a href="gifting.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('gifting','','img/gift_focused.png',1)"><img id="gifting" src="img/gift.png" alt="Gifting"></a></li>
                   <li style="cursor:default"><img src="img/separator.png"></li>
                    <li><a href="cart.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('cart','','img/cart_focused.png',1)"><img id="cart" src="img/cart.png" alt="Cart"></a></li>
                   <li style="cursor:default"><img src="img/separator.png"></li>
                   <li><a href="#login-box" class="login-window" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('login','','img/login_focused.png',1)"><img id="login" src="img/login.png" alt="Login"></a></li>
				</ul>
			</nav>
		</div>
...
Request a new one</a>
              ...
              <input type="submit" value="Login"> 
                <button class="btn" type="button">Login</button> <p style="margin-left:31%; padding-top:2%">OR</p>
	...
	<header class="fixed_nav">
		<div>
        <nav>
				<ul><li style="padding-top:12px"><a href="#"><img src="img/logo_decor_left.png" alt="mymade"></a>
					<li style="padding-top:12px"><a href="enquire.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('enquire_fixed','','img/sample1.png',1)"><img id="enquire_fixed" src="img/enquire.png" alt="Enquire"></a></li>
                  <li style="padding-top:12px; cursor:default"><img src="img/separator.png"></li>
					<li style="padding-top:12px"><a href="gifting.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('gifting_fixed','','img/gift_focused.png',1)"><img id="gifting_fixed" src="img/gift.png" alt="Gifting"></a></li>
                   <li><a href="#"><img src="img/mymade_Logo_small.png" alt="mymade"></a>
                    <li style="padding-top:12px"><a href="cart.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('cart_fixed','','img/cart_focused.png',1)"><img id="cart_fixed" src="img/cart.png" alt="Cart"></a></li>
                    <li style="padding-top:12px; cursor:default"><img src="img/separator.png"></li>
                   <li style="padding-top:12px"><a href="#login-box" class="login-window" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('login_fixed','','img/login_focused.png',1)"><img id="login_fixed" src="img/login.png" alt="Login"></a></li>
                    <li style="padding-top:12px"><a href="#"><img src="img/logo_decore_right.png" alt="mymade"></a>
				</ul>
		  </nav>
	...
	<section class="main-part">
     ...
     <div style="margin-top: 1px">
       ...
       <tr>
        ...
        <td rowspan="2" class="vertical-box">
       ...
       <table style="width: 100%; height: 700px;">
       <tr>
       	<td class="box" style="background-image:url(img/home/png_images/dresses.png)">
        <div class="box-content">
        <h2>DRESS</h2>
        ...
        <td rowspan="2" class="vertical-box" style="background-image:url(img/home/png_images/4.jpg)">
         <div class="vertical-box-content">
       ...
       <tr>
       	<td height="22%" width="100%" colspan="3" style="border-style:solid;border-color:white;border-width:1px; background-image:url(img/home/png_images/fashion-inspiration.png)">
...
margin-right: -180px;">
       ...
       <td class="box" style="background: #d3d3d3">
        <div class="box-content">
        <h2 style="margin-top:35px;margin-right: 42px;">ANARKALI</h2>
       ...
       <tr>
	  	<td class="box-horizontal" colspan="3" style="background: #d3d3d3">
...
margin-right: -150px;">
       ...
       <td class="box" style="background: #d3d3d3">
        <div class="box-content">
        <h2 style="margin-top:35px;margin-right: 40px;">COLLEGE</h2>
       ...
       <td class="box" style="background: #d3d3d3">
        <div class="box-content">
        <h2 style="margin-top:35px;margin-right: 40px;">ANARKALI</h2>
       ...
       <tr>
       <td class="horizontal-row" colspan="3" style="background: #d3d3d3">
