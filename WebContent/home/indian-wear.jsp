...
Request a new one</a>
    ...
    <ul>            
                    <li><a class="selected_fixed_nav" href="#">INDIAN WEAR</a></li>
...
<section class="main-part" style="min-height : 600px; z-index: 5">
       ...
       <td class="box" style="background:url(../img/home/png_images/saree.PNG) no-repeat">
        ...
        <h2 style="margin-right: 29%; margin-top: 22px;text-align:center;">INDIAN<br>WEAR</h2>
      ...
      <td class="box" style="background:url(../img/home/png_images/suit.PNG)">
        ...
        <div style="margin-top: 88px; margin-right: -103px;">
        <p>INDIAN WEAR</p><p>SOPHISTICATION</p></div>
        </div></td>
