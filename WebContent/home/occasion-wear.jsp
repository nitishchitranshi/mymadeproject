...
Request a new one</a>
    ...
    <ul>            
					...
					<li><a class="selected_fixed_nav" href="#">OCCASION WEAR</a></li>
...
<section class="main-part" style="min-height : 600px; z-index: 5">
       ...
       <tr>
        ...
        <h2 style="margin-right: 21%; margin-top: 22px;text-align:center;">OCCASION<br>WEAR</h2>
        <div style= "margin-top: 114px; margin-right: -148px;">
        <p>INDIAN WEAR</p><p>SOPHISTICATION</p></div>
        </div>
